# Getting help with chicagoDA

Thanks for using chicagoDA. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/chicagoDA/issues) to make sure the 
